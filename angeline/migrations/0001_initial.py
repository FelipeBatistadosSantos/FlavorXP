    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(max_length=255, null=True, upload_to='media/', verbose_name='foto-perfil')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_corp', models.EmailField(max_length=100, verbose_name='Email')),
                ('usuario', models.OneToOneField(default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
